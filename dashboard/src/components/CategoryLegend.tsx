...
export const CategoryLegend: React.FC = () => {
  ...
  return (
    <div className="relative inline-block" ref={popoverRef}>
      ...
      {/* Popover */}
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-80 sm:w-96 z-50 rounded-2xl glass-card bg-white/95 dark:bg-[#10131e]/95 border border-slate-200/80 dark:border-white/[0.1] p-5 shadow-2xl shadow-black/20 dark:shadow-black/60 backdrop-blur-2xl animate-count font-sans">
          {/* Header */}
